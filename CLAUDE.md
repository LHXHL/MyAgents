...
| Cloud Space / Space Issue / Space Skill / registered agent（开发中） | `tech_docs/space_cloud.md`；改云端 API / 鉴权 / 数据 / quota 时还 MUST 读同级仓库 `../MyAgents_space/specs/ARCHITECTURE.md` |
