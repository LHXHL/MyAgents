...
const SYSTEM_SKILLS_VERSION: &str = "45";
...
mod system_skills_tests {
    ...
    #[test]
    fn v45_standardizes_skill_metadata_and_preserves_existing_contracts() {
        assert_eq!(CLI_VERSION, "48");
        assert_eq!(SYSTEM_SKILLS_VERSION, "45");
