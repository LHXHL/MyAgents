import type { CapabilityOperationResult, DesktopMessageRequest, SessionEngineCurrentContext } from './types';

/** Replay the stored user input through ordinary desktop admission. */
export function retryDesktopRequest(context: SessionEngineCurrentContext, rewind: CapabilityOperationResult): DesktopMessageRequest {
